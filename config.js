...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Lisamwol' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '919567321848@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    YAK: process.env.YAK === undefined ? '919567321848,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
